...
export default {
  ...
  methods: {
    ...mapActions(["fetchCurrentUser", "fetchReminders", "fetchPreferences", "addPreferences", "fetchLikeButtons", "addLikeButton"]),
  ...
  computed: {
    ...mapGetters(["reminders", "remindersOn", "snackbar", "user", "preferences", "likeButtons"]),
    filteredReminders() {
      const now = new Date();
